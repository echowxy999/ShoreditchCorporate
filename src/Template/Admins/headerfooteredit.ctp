        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-8 col-md-6 col-sm-4">
                        <h3>Edit Header & Footer Content</h3>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="card-body">
                <table style="width: 100%;" class="cartlabel">
                    ...
                    <?php $sum=0; ?>
                    <?php foreach($headerfootercontents as $headerfootercontent){ ?>
                    <tbody>
                    <tr>
                        <?= $this->Form->create($headerfootercontent, ['url' => ['controller' => 'admins', 'action' => 'contentsave', $headerfootercontent->_id]]);?>
                        <th align="right"> <p> <?php echo $headerfootercontent->contentname ?> </p></th>
