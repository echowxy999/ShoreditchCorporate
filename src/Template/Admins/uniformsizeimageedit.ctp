...
<div class="card">
    <?= $this->Form->create($uniform,['url' => ['controller' => 'admins', 'action' => 'uniformsizeimageedit'],'type' =>'file']); ?>
    <h3 class="card-header">Edit <?php echo $uniform->uniformname?> size chart picture</h3>
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <br>
            <?php echo $this->Form->control('sizechartpath', ['type'=>'file', 'required']) ?>
        </div>
