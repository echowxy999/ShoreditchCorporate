...
<div class="row">
    <div class="col-md-6 offset-md-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p id="resetpwdescription"> Please provide your account email address, and we'll send you a code to reset your password</p>
            ...
            <?php
            echo $this->Form->submit('Send reset email', ['class'=>'btn akame-btn active']);
            echo $this->Form->end();
            ?>
            <br>
                <div class="form-group">
