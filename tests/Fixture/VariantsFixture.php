...
class VariantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'size' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'price' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        '_indexes' => [
            'table_name_uniforms__id_fk' => ['type' => 'index', 'columns' => ['uniform_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['_id'], 'length' => []],
            'variants__id_uindex' => ['type' => 'unique', 'columns' => ['_id'], 'length' => []],
            'table_name_uniforms__id_fk' => ['type' => 'foreign', 'columns' => ['uniform_id'], 'references' => ['uniforms', '_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
